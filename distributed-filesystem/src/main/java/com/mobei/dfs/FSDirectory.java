...
public class FSDirectory {
    ...
    public void mkdir(String path) {
        ...
        synchronized (dirTree) {
            ...
            for (String splittedPath : paths) {
                if (splittedPath.trim().equals("")) {
                    continue;
                }

                INodeDirectory dir = findDirectory(dirTree, splittedPath);
                if (dir != null) {
                    parent = dir;
                    continue;
                }

                INodeDirectory child = new INodeDirectory(splittedPath);
